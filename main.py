...
while run:
  ...
  #Updates level when completed

  if start_game == False:
    screen.fill(constants.MENU_BG)
    start = pygame.image.load('assets/images/entranceArt.png').convert_alpha()
    start = pygame.transform.scale(start, (800,800))
    ...
    if pause_game == True:
      ...
      if level == 5:
          win = pygame.image.load('assets/images/trophyWinScreen.png').convert_alpha()
          win = pygame.transform.scale(win, (constants.SCREEN_WIDTH,constants.SCREEN_HEIGHT))
          screen.blit(win, (0,0))
          pygame.mixer.music.stop()
          pygame.mixer.music.load('assets/audio/victory_song.mp3') 
          pygame.mixer.music.set_volume(0.3)
          pygame.mixer.music.play(-1, 0.0, 5000)
